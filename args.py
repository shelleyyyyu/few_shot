...
def read_options():
    ...
    parser.add_argument("--dataset", default="ARMY", type=str)
    ...
    parser.add_argument("--max_batches", default=1000, type=int)
    ...
    parser.add_argument("--embed_model", default=None, type=str)
